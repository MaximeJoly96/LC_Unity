                ...
                foreach (XmlNode evt in baseNode)
                {
                    ...
                    switch (eventType)
                    {
                        ...
                        case EventType.InventoryCondition:
                            ...
                            break;
                        case EventType.QuestCondition:
                            sequence.Add(XmlFlowControlParser.ParseQuestCondition(evt));
                            break;
                        ...
                        case EventType.ShowAgentAnimation:
                            ...
                            break;
                        case EventType.DisableAgent:
                            sequence.Add(XmlCharacterParser.ParseDisableAgent(evt));
                            break;
